 ...
 */
public class WPILibMotionProfile {
	 ...
	 */
	public WPILibMotionProfile(Constraints constraints, State goal, State initial) {
	 ...
	 * @param goal        The desired state when the profile is complete.
	 */
	public WPILibMotionProfile(Constraints constraints, State goal) {
